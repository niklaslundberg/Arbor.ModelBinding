...
{
    public class SystemJsonConverterHttpTests
    {
        private readonly ITestOutputHelper _testOutputHelper;
        private readonly TestServer _testServer;

        public SystemJsonConverterHttpTests(ITestOutputHelper testOutputHelper)
        {
            ...
            var builder = new WebHostBuilder()
                .ConfigureServices(services => services.AddControllers(
                    ...
                    options =>
                    {
                        foreach (var jsonConverter in GeneratedJsonConverters.SystemJsonConverters)
                        {
